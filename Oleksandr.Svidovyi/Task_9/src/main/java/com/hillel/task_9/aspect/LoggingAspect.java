...
public class LoggingAspect {
    ...
    @AfterReturning(pointcut = "execution(* com.hillel.task_9.service.*.*(..))", returning = "object")
    public void serviceReturningLog(Object object) {
        if (object != null) log.info("Service returned [{}]", object.toString());
    }


    @AfterReturning(pointcut = "execution(* com.hillel.task_9.repository.*.*(..))", returning = "object")
