...
public class CardServiceImplTest {
    ...
    public void getCardsList() {
        when(cardRepository.getCardsList()).thenReturn(Arrays.asList(
    ...
    public void getCard() {
        ...
        when(cardRepository.getCardById(cardIdArgCaptor.capture())).thenReturn(new BankCard(1, "Privat", new HashSet<>()));
